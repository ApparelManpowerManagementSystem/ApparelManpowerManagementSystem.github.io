<?php
	...
	if($_SESSION['userStatus']=='offline'){
		...
		$query="SELECT * FROM worker_pending,worker,supplier_job,location WHERE worker_pending.workerID='W12345' AND worker.workerID=worker_pending.workerID AND worker_pending.jobID=supplier_job.jobID AND supplier_job.locationID=location.locID";
