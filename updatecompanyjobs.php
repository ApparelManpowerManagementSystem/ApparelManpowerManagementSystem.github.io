...
$query = "UPDATE company_job SET jobTitle='$jobTitle' , jobType='$jobType',jobAmount='$jobAmount',jobPeriod='$jobPeriod',jobPrice='$jobPrice',jobDate='$jobDate',jobStatus='$jobStatus',comID='$comID', supID='$supID' WHERE jobID=$jobID";
...
<title> Update Jobs Details</title>
  <meta charset="utf-8">
...
<div class="container">
     <h2>Update Company Jobs Details</h2>
<form method="POST" action="updatecompanyjobs.php">
