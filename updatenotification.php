...
$query = "UPDATE notification SET notification='$notification' , userType='$userType' WHERE notificationID='$notificationID'";
...
<form method="POST" action="updatenotification.php">
