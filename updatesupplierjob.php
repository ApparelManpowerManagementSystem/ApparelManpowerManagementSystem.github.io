...
$query = "UPDATE supplier_job SET jobTitle='$jobTitle',jobType='$jobType',jobCount='$jobCount',workerCount='$workerCount',jobPeriod='$jobPeriod',jobStatus='$jobStatus',jobStart='$jobStart',jobEnd='$jobEnd',jobProgress='$jobProgress',supID='$supID',locationID='$locationID' WHERE jobID=$jobID";
...
<div class="container">
     <h2>Update Supplier Jobs Details</h2>
<form method="POST" action="updatesupplierjob.php">
